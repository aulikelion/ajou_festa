...
class TimetablesControllerTest < ActionController::TestCase
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post :create, timetable: { content: @timetable.content, date: @timetable.date, end_time: @timetable.end_time, location: @timetable.location, name: @timetable.name, start_time: @timetable.start_time }
    end
  ...
  test "should update timetable" do
    patch :update, id: @timetable, timetable: { content: @timetable.content, date: @timetable.date, end_time: @timetable.end_time, location: @timetable.location, name: @timetable.name, start_time: @timetable.start_time }
    assert_redirected_to timetable_path(assigns(:timetable))
  end
